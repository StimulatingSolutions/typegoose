...
describe('Typegoose', () => {
    ...
    it('should add compound index', () => __awaiter(this, void 0, void 0, function* () {
        const user = yield user_1.model.findOne();
        const car = yield car_1.model.findOne();
        yield rating_1.model.create({ user: user._id, car: car._id, stars: 4 });
        // should fail, because user and car should be unique
        const created = yield rating_1.model.create({ user: user._id, car: car._id, stars: 5 })
...
describe('getClassForDocument()', () => {
    ...
    it('Should validate email', () => __awaiter(this, void 0, void 0, function* () {
        try {
            yield person_1.model.create({
                email: 'email',
            });
            assert_1.fail('Validation must fail.');
        }
